...
class Ui_Dialog(QtWidgets.QWidget):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(541, 431)
        Dialog.setMinimumSize(QtCore.QSize(541, 431))
        Dialog.setMaximumSize(QtCore.QSize(541, 431))
        ...
        self.button_about = QtWidgets.QPushButton(
            Dialog, clicked=lambda: webbrowser.open('https://github.com/ohmono/analizador-lexico'))
        self.button_about.setGeometry(QtCore.QRect(444, 390, 91, 23))
        ...
        self.button_clear.setGeometry(QtCore.QRect(110, 390, 75, 23))
        self.button_clear.setObjectName("button_clear")
        self.button_upload = QtWidgets.QPushButton(
            Dialog, clicked=lambda: self.click_upload())
        self.button_upload.setGeometry(QtCore.QRect(10, 20, 91, 23))
        self.button_upload.setObjectName("button_upload")
        self.button_draw = QtWidgets.QPushButton(
            Dialog, clicked=lambda: self.click_draw())
        self.button_draw.setGeometry(QtCore.QRect(140, 20, 91, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.button_draw.setText(_translate("Dialog", "Escribir código"))
